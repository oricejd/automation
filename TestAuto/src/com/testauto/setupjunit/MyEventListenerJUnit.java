...
import static com.testauto.setupjunit.SeleniumTestCaseJUnit.LOG;
...
public class MyEventListenerJUnit implements WebDriverEventListener {	
	...
	private String getClassName() {
		...
		for (StackTraceElement stackTraceElement : stackTraceElements) {
			if (stackTraceElement.getClassName().contains("objects")){
				...
				return stackTraceElement.getClassName();
			}else if(stackTraceElement.getClassName().equals(SeleniumTestCaseJUnit.class.getName())){
				return stackTraceElement.getClassName();
			}
		}
		return "Other";		
